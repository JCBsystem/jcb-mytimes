...
- [x] **MEM-01**: User can create a memory with text content
- [x] **MEM-02**: User can attach a photo to a memory (Firebase Storage upload)
- [x] **MEM-03**: User can add tags to a memory
